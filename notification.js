...
function tabClicked(tab) {
	if (tab === "cheats") {
		// New Cheats tab - no special logic needed yet, but allows switch back
	} else if (tab != "resources") {
		document.getElementById("resourcesTabGlyph").className = "glyphicon glyphicon-exclamation-sign hidden";
	}
}
